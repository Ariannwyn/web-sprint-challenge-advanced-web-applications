...
- They provide proof that a user is authenticated or logged in.

2. What steps can you take in your web apps to keep your data secure?

- By using Private Routes and tokens so that users have to log in.

3. Describe how web servers work.

- A physical web server stores code for websites and "host" that code so we can access it across the web.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

- C: Post method. R: Get method. U: Put method. D: Delete method.
